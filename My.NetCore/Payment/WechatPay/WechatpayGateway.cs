...
namespace My.NetCore.Payment.WechatPay
{
        ...
        IQuery, ICancel, IClose, IBillDownload, IRefund, IRefundQuery
    {
        ...
        protected internal override string[] NotifyVerifyParameter => 
            new string[]{ Constant.RETURN_CODE, Constant.APPID, Constant.MCH_ID, Constant.NONCE_STR, Constant.RESULT_CODE };
        ...
        protected internal override void WriteSuccessFlag()
        {
            GatewayData.Add(Constant.RETURN_CODE, SUCCESS);
            HttpUtil.Write(GatewayData.ToXml());
        }

        protected internal override void WriteFailureFlag()
        {
